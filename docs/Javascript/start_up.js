...
import { play_area_direction_row } from "./tools";
import { display_replay_button } from "./tools";
import { display_attribution } from "./tools";
import { director } from "./main";
import { update_play_area } from "./main";
...
function start_game() {
    ...
    var path_taken = JSON.parse(localStorage.getItem("path_taken"));
    var state_of_game = "0";
...
function change_theme(dark_theme) {
    localStorage.setItem("dark_theme", JSON.stringify(dark_theme));
    const state_of_game = JSON.parse(localStorage.getItem("state_of_game"));
...
;
//# sourceMappingURL=start_up.js.map