...
import {end_game_conversion} from "./end_game";
import {event_name_conversion} from "./event";

function director (path_taken: string[][], signal:string) {
...
function update_play_area (path_taken: string[][]) {
...
function generate_end_game (path_taken:string[][]) {
